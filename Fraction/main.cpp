...
/*
This program runs based on fraction class and its implementation that includes functions and overloading operators.
Comparing the result of this program and comments allow me to check if I have implemented all the requirement correctly.

By testing this program, I can ensure that a fraction objects can be created by using integers and double.
Thus, I have overloaded and tested relational, stream, and arithmetics operators (<, >, <=, >=, ==, +, -, /, *, << and >>)
*/
#include <iostream>
#include <iomanip>
using namespace std;
